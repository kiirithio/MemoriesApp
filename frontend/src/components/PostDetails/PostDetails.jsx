...
const PostDetails = () => {
    ...
    var timeOnly = new Date(datetime).toLocaleTimeString();
      ...
      <Paper style={{ padding: '20px', borderRadius: '15px' }} elevation={6}>
        <div className={classes.card}>
          <div className={classes.section}>
            ...
            <Typography variant="h5" component="h5">Date: {dateOnly} Time: {timeOnly}</Typography>
            ...
            <div className={classes.recommendedPosts}>
              {recommendedPosts.map(({ title, username, message, likes, selectedFile, _id }) => (
                <div style={{ margin: '20px', cursor: 'pointer' }} onClick={() => openPost(_id)} key={_id}>
                  ...
                  <Typography gutterBottom variant="subtitle1">Pledges: {likes.length}</Typography>
